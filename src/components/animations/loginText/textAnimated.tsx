...
export default function TextAnimated() {
  ...
  const reset = useCallback(() => {
    ...
    ref.current = []
    set([])
    ref.current.push(setTimeout(() => set(['Desenvolver', 'Aprimorar', 'Exercitar']), 2000))
    ref.current.push(setTimeout(() => set(['Desenvolver', 'Exercitar']), 5000))
    ref.current.push(setTimeout(() => set(['Desenvolver', 'Simplificar', 'Exercitar']), 8000))
  }, [])
